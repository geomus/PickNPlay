...
// Login
router.post("/login", guestUser, [check("email").isEmail().withMessage("Formato de email incorrecto?"),
body("email")
    .custom(async (value) => {
        //console.log(value);
        let emailsEnUso = await db.Users.findOne({
    ...
    .withMessage("Ese email ya esta en uso"),],usersController.processLogin);
